...
export class ElectricianBoerneTxComponent implements OnInit {
  ...
  pageUrl = FullSitePaths.boerneTxElectrician;
  ...
  //     title: 'Electrician in Boerne, TX | Repairs, Panels & Lighting Upgrades',
  //     description:
  ...
  //   const baseUrl = SiteData.baseUrl; // https://provoltelectricalservices.com
