...
export const SiteData = {
  ...
  canonicalUrl: new URL('/', environment.baseUrl).toString(),
  homepageImageUrl: new URL(
    '/assets/brand/og/provolt-primary-logo-og-c.png',
    environment.baseUrl
  ).toString(),
  textMessageSharedLogoUrl: new URL(
    '/assets/brand/logos/ProVolt-Logo-meta-512-c.png',
    environment.baseUrl
  ).toString(),
  ...
  businessRegion: 'Texas Hill Country',
  googleMapsUrl:
